...
func New() *echo.Echo {
	...
	eAuth.POST("/cart/:id/item", controllers.CreateCartItemController)
	eAuth.PUT("/cart/:id/item", controllers.UpdateCartItemController)
	eAuth.DELETE("/cart/:id/item", controllers.DeleteCartItemController)
